        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="aboutus.php" class="text-muted text-decoration-none small">About Us</a></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><span class="text-muted small">Individual Counseling</span></li>
                    <li class="mb-2"><span class="text-muted small">Group Therapy</span></li>
                    <li class="mb-2"><span class="text-muted small">Crisis Support</span></li>
                    <li class="mb-2"><span class="text-muted small">Academic Counseling</span></li>
